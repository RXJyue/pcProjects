...
from components.widgets import initial_label_frame, initial_entry, initial_label, initial_button,initial_image
from tkinter import *
...
def initial_label_frame_fft_control(parent, gv):
    ...
    label_frame_fft_control.configure(height=120, font=("Sitka Heading", 12, "bold"))
...
def fill_label_frame_fft_control(parent, gv):
    ...
    button_save = initial_button(parent, "Report\nGenerate")
    button_save.configure(width=100, #font=('Microsoft YaHei', '11', 'bold'),
                          image=img_report, compound=LEFT)
    button_save.image = img_report
    button_save.grid(row=0, column=10, rowspan=2, padx=4, pady=4, sticky=NSEW)
    #href="https://www.flaticon.com/free-icons/standardization"