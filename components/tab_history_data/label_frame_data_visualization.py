from components.widgets import initial_label_frame, initial_button, initial_checkbutton, initial_label, initial_entry, \
    initial_frame
from tkinter import *
...
def fill_frame_bottom(parent, gv):
    ...
    button_save.configure(width=7, font=('arial','11','bold'))
