from components.widgets import initial_label_frame, initial_button, initial_checkbutton, initial_combobox, \
    initial_label, initial_entry
from tkinter import *
...
def fill_label_frame_data_process(parent, gv):
    ...
    checkbutton_z_select.configure(width=11, variable=gv.var["checkbutton_z_select"],
